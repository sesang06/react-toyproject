  ...
  render() {
    ...
    if (this.props.loginStatus === 1) {
      return (
        <div>
        <div>
        {this.props.uname===this.props.match.params.username?<h1>내 담벼락</h1>:<h1>{this.props.match.params.username}님의 담벼락</h1>}
        {this.props.uname===this.props.match.params.username?
          <div>
          <Link className="Button" to={'/wall/'}>담벼락 메인으로 돌아가기</Link>
          <Link className="Button" to={'/timeline/'}>내 타임라인 보러가기</Link>
